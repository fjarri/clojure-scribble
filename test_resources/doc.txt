; Taken from https://github.com/plt/racket/ repo
; (/pkgs/scribble-pkgs/scribble-doc/scribblings/scribble/reader.scrbl)
; We need some big file in Scribble format to test the reader's performance.
;
; The following changes were made (to conform to Clojure syntax):
; - '#:' replaced by ':'
; - '#,' replaced by '~'
